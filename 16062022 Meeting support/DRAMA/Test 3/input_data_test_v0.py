...
def get_files(image_dir,csv_dir,batch_size):#return list of images and labels
    return get(image_dir,csv_dir,batch_size,'beautiful',1000),\
            get(image_dir,csv_dir,batch_size,'boring',1500),\
            get(image_dir,csv_dir,batch_size,'depressing',1800),\
            get(image_dir,csv_dir,batch_size,'lively',1600),\
            get(image_dir,csv_dir,batch_size,'safe',1700),\
            get(image_dir,csv_dir,batch_size,'wealthy',1400)
