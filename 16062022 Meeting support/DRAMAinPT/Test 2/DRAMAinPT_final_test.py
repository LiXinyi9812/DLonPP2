...
def get(image_dir,csv_dir,batch_size,attribute,j):
    ...
    num_validation = int(num*0.2)//batch_size * batch_size#0.05
    num_test = int(num*0.1)//batch_size * batch_size#0.35
...
def get_files(image_dir,csv_dir,batch_size):#return list of images and labels
    return get(image_dir,csv_dir,batch_size,'beautiful',80),\
            get(image_dir,csv_dir,batch_size,'boring',90),\
            get(image_dir,csv_dir,batch_size,'depressing',100),\
            get(image_dir,csv_dir,batch_size,'lively',110),\
            get(image_dir,csv_dir,batch_size,'safe',110),\
            get(image_dir,csv_dir,batch_size,'wealthy',90)
...
vgg_extra = models.vgg19(pretrained=True)
vgg_extra.to(device)
...
##prepare dataset
image_dir = 'D:/Desktop/personal/stage/AAu/DLonPP2project/ds/images'
csv_dir = 'D:/Desktop/personal/stage/AAu/DLonPP2project/ds/votes_convert.csv'
...
print(num,num_validation,num_test)
...
outputdir = 'D:/Desktop/personal/stage/AAu/DLonPP2project/code/ex_MTL_DRAMA/outputs'
...
#test
vgg_extra_test = models.vgg19().to(device)
