We develop MFA model based on DRAMA architecture, and introduce the attention module. Besides, we use the segmentation mask and semantic information as additional inputs.  
