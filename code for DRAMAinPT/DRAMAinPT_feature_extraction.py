...
from model_addseg import create_DRAMA,get_vgg_backbone,fusion_net
import utils
...
def get_args_parser():
    ...
    parser.add_argument('--output-dir', default='./output_e2_add_feature', help='path where to save')
    parser.add_argument('--name', default='', help="Prefix name for the output dir (default: '')")
    parser.add_argument('--resume', default='No_1')
...
def get(args):
    ...
    for attribute in data_train:
        data_train[attribute] = PP2HDF5Dataset(votes_path=args.dataset+str(attribute) + '_train.csv',hdf5_ori_path=hdf5_original_path, hdf5_seg_path=hdf5_seg_path)
        data_validation[attribute] = PP2HDF5Dataset(votes_path=args.dataset + str(attribute) + '_val.csv',hdf5_ori_path=hdf5_original_path, hdf5_seg_path=hdf5_seg_path)
        data_test[attribute] = PP2HDF5Dataset(votes_path=args.dataset + str(attribute) + '_test.csv',hdf5_ori_path=hdf5_original_path, hdf5_seg_path=hdf5_seg_path)
...
def main(args):
    ...
    #     model_drama[0].load_state_dict(cp['model_drama_safe'])
    #     model_drama[1].load_state_dict(cp['model_drama_lively'])
    #     model_drama[2].load_state_dict(cp['model_drama_beautiful'])
    #     model_drama[3].load_state_dict(cp['model_drama_wealthy'])
    #     model_drama[4].load_state_dict(cp['model_drama_depressing'])
    #     model_drama[5].load_state_dict(cp['model_drama_boring'])
    #
    #     optimizer_vgg.load_state_dict(cp['optimizer_vgg'])
    #     optimizer_drama[0].load_state_dict('optimizer_drama_safe')
    #     optimizer_drama[1].load_state_dict('optimizer_drama_lively')
    #     optimizer_drama[2].load_state_dict('optimizer_drama_beautiful')
    #     optimizer_drama[3].load_state_dict('optimizer_drama_wealthy')
    #     optimizer_drama[4].load_state_dict('optimizer_drama_depressing')
    #     optimizer_drama[5].load_state_dict('optimizer_drama_boring')
    #
    #     lr_scheduler_vgg.load_state_dict(cp['lr_scheduler_vgg'])
    #     lr_scheduler_drama[0].load_state_dict(cp['lr_scheduler_drama_safe'])
    #     lr_scheduler_drama[1].load_state_dict(cp['lr_scheduler_drama_lively'])
    #     lr_scheduler_drama[2].load_state_dict(cp['lr_scheduler_drama_beautiful'])
    #     lr_scheduler_drama[3].load_state_dict(cp['lr_scheduler_drama_wealthy'])
    #     lr_scheduler_drama[4].load_state_dict(cp['lr_scheduler_drama_depressing'])
    #     lr_scheduler_drama[5].load_state_dict(cp['lr_scheduler_drama_boring'])
    #
